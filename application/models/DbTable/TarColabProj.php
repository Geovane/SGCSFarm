<?php
/**
 * Esta classe tem como objetivo efetuar a conexão do sistema com a view 'tarefa_colaborador_projetos'
 ...
 */
class Model_DbTable_TarColabProj extends Zend_Db_Table_Abstract
{
    ...
    * @name $_name
    */
    protected $_name = 'tarefa_colaborador_projetos';
