<?php
/**
 * Esta classe tem como objetivo efetuar a conexão do sistema com a view 'colaboradores_projetos'
 ...
 */
class Model_DbTable_ColaboradoresProjetos extends Zend_Db_Table_Abstract
{
    ...
    * @name $_name
    */
    protected $_name = 'colaboradores_projetos';
